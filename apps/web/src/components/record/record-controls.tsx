...
function ControlTile({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      className={cn(
        "flex h-[76px] flex-1 flex-col items-center justify-center gap-1.5 rounded-[22px] text-ink shadow-soft focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink/40",
        className,
      )}
    >
      {children}
