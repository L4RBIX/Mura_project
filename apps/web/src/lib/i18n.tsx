...
const ui = {
  ru: {
    ...
    listening: "Слушаю",
    mixedSpeechRecognition: "Слушаю. Говорите по-казахски и по-русски вперемешку.",
    recognizingLive: "GigaAM распознаёт речь…",
    recognizingSpeech: "Распознаём всю запись…",
    ...
    pause: "Пауза",
    finish: "Готово",
    uploading: "Сохраняем запись…",
    microphoneError: "Не удалось открыть микрофон. Разрешите доступ и попробуйте снова.",
    uploadError: "Не удалось сохранить запись. Попробуйте ещё раз.",
    noSpeechError: "Речь не распознана. Скажите несколько слов и попробуйте снова.",
    audioMemoryTitle: "Новая аудиозапись",
    audioMemoryTitleWithDate: "Воспоминание · {date}",
    genericNarrator: "Рассказчик",
    transcriptUnavailable: "Текст не распознан, но аудиозапись сохранена.",
    audioOnlyNotice: "GigaAM пока не получил завершённую расшифровку. Исходная аудиозапись сохранена на этом устройстве без выдуманного текста.",
    audioFileLabel: "Аудиофайл",
    downloadAudio: "Скачать",
    photos: "Фотографии",
    photosEmpty: "Добавьте снимки, которые относятся к этому воспоминанию.",
    uploadPhotos: "Загрузить",
    takePhoto: "Снять",
    dragToReorder: "Можно менять порядок",
    deletePhoto: "Удалить фотографию",
    openPhoto: "Открыть фотографию {number}",
    closePhoto: "Закрыть фотографию",
    photoStorageError: "Не удалось сохранить фотографию на этом устройстве.",
    saveToMyMemories: "Сохранить в мои воспоминания",
    favoriteSaved: "Сохранено",
    favoriteMemories: "Мои любимые воспоминания",
    openFavorites: "Любимые воспоминания",
    searchFavorites: "Найти воспоминание",
    allMemories: "Все",
    withPhotos: "С фотографиями",
    filterByPerson: "Фильтр по человеку",
    allPeople: "Все люди",
    removeFavorite: "Убрать из любимых",
    noFavoriteMemories: "Сохранённые воспоминания появятся здесь.",
    noFavoriteResults: "По вашему запросу ничего не найдено.",
    narratorLabel: "Рассказчик",
    mentionedPersonLabel: "Упомянуты",
    timeline: "Хронология",
    analysisInProgress: "Анализируем сохранённую расшифровку…",
    analysisFailedTitle: "Анализ не завершён",
    retryAnalysis: "Повторить анализ",
    resumeAnalysis: "Продолжить анализ",
    retryingAnalysis: "Запускаем анализ…",
    technicalCode: "Код",
    ...
    processingPrepare: "Готовим расшифровку…",
    processingAnalyze: "Анализируем семейную историю…",
    processingOrganize: "Сохраняем людей и события…",
    processingSafe: "Ваши слова в безопасности. Нужно немного времени.",
    processingFailed: "Анализ не завершился. Запись сохранена, и его можно повторить.",
    privateBadge: "Личное",
    needsReview: "Нужно проверить",
    evidenceLabel: "Фрагменты",
    peopleSection: "Люди",
    relationshipsSection: "Связи",
    eventsSection: "События",
    otherStoriesSection: "Другие истории",
    reviewItemsSection: "Нужно уточнить",
    aliasesLabel: "Другие имена",
    categoryLabel: "Категория",
    participantsLabel: "Участники",
    dateLabel: "Дата",
    locationLabel: "Место",
    categoryFamilyMember: "Член семьи",
    categoryFriend: "Друг или подруга",
    categoryOther: "Другой человек",
    categoryUnknown: "Не определено",
    relationshipParentChild: "Родитель и ребёнок",
    relationshipSpouse: "Супруги",
    relationshipSibling: "Братья или сёстры",
    relationshipOther: "Другая связь",
    roleParent: "родитель",
    roleChild: "ребёнок",
    roleSpouse: "супруг или супруга",
    roleSibling: "брат или сестра",
    roleOlderSibling: "старший брат или сестра",
    roleYoungerSibling: "младший брат или сестра",
    roleUnknown: "роль не определена",
    reviewAmbiguity: "Неоднозначность",
    reviewConflict: "Противоречие",
    reviewMissingEvidence: "Не хватает подтверждения",
    reviewOther: "Требует внимания",
    errorBackendNotConfigured: "Сервис анализа ещё не настроен. Запись и расшифровка сохранены.",
    errorBackendUnreachable: "Сервис анализа сейчас недоступен. Попробуйте ещё раз позже.",
    errorBackendTimeout: "Анализ занял слишком много времени. Запись сохранена — можно повторить попытку.",
    errorBackendUnauthorized: "Серверы Mura не смогли подтвердить доступ к модели. Запись сохранена.",
    errorInvalidModelResponse: "Модель вернула неполный результат. Попробуйте анализ ещё раз.",
    errorInvalidRequest: "Расшифровку не удалось подготовить для анализа. Запись сохранена.",
    errorProviderUnavailable: "Провайдер модели временно недоступен. Попробуйте позже.",
    errorRepairFailed: "Модель не смогла подготовить корректный результат. Можно повторить анализ.",
    errorUnexpected: "Не удалось завершить анализ. Запись и расшифровка сохранены.",
  ...
  kk: {
    ...
    mixedSpeechRecognition: "Тыңдап тұрмын. Қазақша және орысша араластырып сөйлей беріңіз.",
    recognizingLive: "GigaAM сөйлеуді танып жатыр…",
    recognizingSpeech: "Жазбаның толық мәтінін дайындап жатырмыз…",
    ...
    pause: "Кідірту",
    finish: "Аяқтау",
    uploading: "Жазба сақталып жатыр…",
    microphoneError: "Микрофон ашылмады. Рұқсат беріп, қайта көріңіз.",
    uploadError: "Жазбаны сақтау мүмкін болмады. Қайта көріңіз.",
    noSpeechError: "Сөйлеу танылмады. Бірнеше сөз айтып, қайта көріңіз.",
    audioMemoryTitle: "Жаңа аудиожазба",
    audioMemoryTitleWithDate: "Естелік · {date}",
    genericNarrator: "Әңгімелеуші",
    transcriptUnavailable: "Мәтін танылмады, бірақ аудиожазба сақталды.",
    audioOnlyNotice: "GigaAM әзірге толық мәтін алған жоқ. Бастапқы аудиожазба ойдан шығарылған мәтінсіз осы құрылғыда сақталды.",
    audioFileLabel: "Аудиофайл",
    downloadAudio: "Жүктеп алу",
    photos: "Фотосуреттер",
    photosEmpty: "Осы естелікке қатысты фотосуреттерді қосыңыз.",
    uploadPhotos: "Жүктеу",
    takePhoto: "Суретке түсіру",
    dragToReorder: "Ретін өзгертуге болады",
    deletePhoto: "Фотосуретті жою",
    openPhoto: "{number}-фотосуретті ашу",
    closePhoto: "Фотосуретті жабу",
    photoStorageError: "Фотосуретті осы құрылғыда сақтау мүмкін болмады.",
    saveToMyMemories: "Менің естеліктеріме сақтау",
    favoriteSaved: "Сақталды",
    favoriteMemories: "Менің сүйікті естеліктерім",
    openFavorites: "Сүйікті естеліктер",
    searchFavorites: "Естелікті іздеу",
    allMemories: "Барлығы",
    withPhotos: "Фотосуреттермен",
    filterByPerson: "Адам бойынша сүзгі",
    allPeople: "Барлық адамдар",
    removeFavorite: "Сүйіктілерден алып тастау",
    noFavoriteMemories: "Сақталған естеліктер осында пайда болады.",
    noFavoriteResults: "Сұрауыңыз бойынша ештеңе табылмады.",
    narratorLabel: "Әңгімелеуші",
    mentionedPersonLabel: "Аталғандар",
    timeline: "Хронология",
    analysisInProgress: "Сақталған мәтін талданып жатыр…",
    analysisFailedTitle: "Талдау аяқталмады",
    retryAnalysis: "Талдауды қайталау",
    resumeAnalysis: "Талдауды жалғастыру",
    retryingAnalysis: "Талдау басталып жатыр…",
    technicalCode: "Код",
    ...
    processingPrepare: "Мәтінді дайындап жатырмыз…",
    processingAnalyze: "Отбасы тарихын талдап жатырмыз…",
    processingOrganize: "Адамдар мен оқиғаларды сақтап жатырмыз…",
    processingSafe: "Сөздеріңіз қауіпсіз. Аз ғана уақыт қажет.",
    processingFailed: "Талдау аяқталмады. Жазба сақталды, оны қайта бастауға болады.",
    privateBadge: "Жеке",
    needsReview: "Тексеру керек",
    evidenceLabel: "Үзінділер",
    peopleSection: "Адамдар",
    relationshipsSection: "Байланыстар",
    eventsSection: "Оқиғалар",
    otherStoriesSection: "Басқа әңгімелер",
    reviewItemsSection: "Нақтылау керек",
    aliasesLabel: "Басқа есімдер",
    categoryLabel: "Санат",
    participantsLabel: "Қатысушылар",
    dateLabel: "Күні",
    locationLabel: "Орны",
    categoryFamilyMember: "Отбасы мүшесі",
    categoryFriend: "Дос",
    categoryOther: "Басқа адам",
    categoryUnknown: "Белгісіз",
    relationshipParentChild: "Ата-ана және бала",
    relationshipSpouse: "Ерлі-зайыптылар",
    relationshipSibling: "Аға-інілер немесе әпке-сіңлілер",
    relationshipOther: "Басқа байланыс",
    roleParent: "ата-ана",
    roleChild: "бала",
    roleSpouse: "жұбай",
    roleSibling: "аға-іні немесе әпке-сіңлі",
    roleOlderSibling: "үлкен аға немесе әпке",
    roleYoungerSibling: "кіші іні немесе сіңлі",
    roleUnknown: "рөлі белгісіз",
    reviewAmbiguity: "Екіұштылық",
    reviewConflict: "Қайшылық",
    reviewMissingEvidence: "Дәлел жетіспейді",
    reviewOther: "Назар аудару керек",
    errorBackendNotConfigured: "Талдау сервисі әлі бапталмаған. Жазба мен мәтін сақталды.",
    errorBackendUnreachable: "Талдау сервисі қазір қолжетімсіз. Кейінірек қайталап көріңіз.",
    errorBackendTimeout: "Талдау тым ұзаққа созылды. Жазба сақталды — әрекетті қайталауға болады.",
    errorBackendUnauthorized: "Mura серверлері модельге қолжетімділікті растай алмады. Жазба сақталды.",
    errorInvalidModelResponse: "Модель толық емес нәтиже қайтарды. Талдауды қайталап көріңіз.",
    errorInvalidRequest: "Мәтінді талдауға дайындау мүмкін болмады. Жазба сақталды.",
    errorProviderUnavailable: "Модель провайдері уақытша қолжетімсіз. Кейінірек қайталаңыз.",
    errorRepairFailed: "Модель дұрыс нәтиже дайындай алмады. Талдауды қайталауға болады.",
    errorUnexpected: "Талдауды аяқтау мүмкін болмады. Жазба мен мәтін сақталды.",
