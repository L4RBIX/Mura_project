...
const ui = {
  ru: {
    ...
    audioOnlyNotice: "Браузер не получил завершённую расшифровку. Аудиозапись сохранена только на этом устройстве и не отправлялась на анализ.",
  ...
  kk: {
    ...
    audioOnlyNotice: "Браузер аяқталған мәтінді ала алмады. Аудиожазба тек осы құрылғыда сақталды және талдауға жіберілген жоқ.",
