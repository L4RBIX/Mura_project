...
const ui = {
  ru: {
    ...
    listening: "Слушаю",
    mixedSpeechRecognition: "Говорите по-казахски и по-русски вперемешку. Точная расшифровка появится после завершения.",
  ...
  kk: {
    ...
    mixedSpeechRecognition: "Қазақша және орысша араластырып сөйлей беріңіз. Нақты мәтін жазу аяқталғаннан кейін шығады.",
